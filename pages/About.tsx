        ...
        <div className="space-y-6 text-left bg-brand-50 p-8 rounded-xl border border-brand-200">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-lg font-medium text-stone-900">[Numele Elevului]</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-lg font-medium text-stone-900">a VII-a</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-lg font-medium text-stone-900">2023 - 2024</p>
            </div>
          </div>
        </div>
